...
<style scoped>
    ...
    .header-decription_text {
        color: #FFFFFF;
        line-height: 30px;
    }

    .header-decription_back-text {
        position: absolute; 
        top: 100px;  
        color: #FFFFFF; 
        left: 50%; 
